...
Un \texttt{Layer<T, P>} è, nel modello di Alchemist, una funzione che associa a
...
La navigazione fra le fasi segue un approccio ipermediale: ogni risposta espone un vettore

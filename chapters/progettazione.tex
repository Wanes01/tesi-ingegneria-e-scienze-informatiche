...
Nessuno di questi passi accede a risorse esterne, come \req{NF7} richiede: la serie di
...
provengano da un data store Copernicus o da un'altra fonte.
...
È questa suddivisione a rendere effettivo \req{NF2}: una fonte diversa,
anche con formato e protocollo differenti, richiede soltanto una nuova coppia
\texttt{CacheKey} ed \texttt{ExternalDataProvider<R>}, senza modificare il gestore della cache.

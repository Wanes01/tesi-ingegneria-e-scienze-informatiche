...
A conferma di \req{F11} anche \texttt{SeparableSpatioTemporalInterpolation} è stato dichiarato
nel file di configurazione, specificando l'argomento \texttt{interpolation} del layer,
come mostra il \Cref{lis:separableval}.

...
L'obiettivo del lavoro era dotare Alchemist della capacità
...
nei quattro sottomoduli descritti nel \Cref{chap:progettazione} ed esprimibile
in modo dichiarativo interamente nella configurazione della simulazione.
...
spaziale e temporale entro la quale la grandezza di riferimento è nota, e trattano
...
La risoluzione di una posizione e di un istante in un valore è compito
del layer e delle strategie
...
trova i campioni pertinenti all'istante in cui viene interrogato e affida
...
L'acquisizione è raccolta in un sottosistema a sé,
...
La validazione copre tutto il modulo: una suite di test
...
\begin{itemize}
  ...
  Di conseguenza resta fuori portata ogni
  ...
  Nella modalità che acquisisce i dati da un data store tale nome non è noto prima
...
La struttura del modulo rende possibili alcune direzioni di sviluppo future senza
...
modifiche sul dominio temporale resterebbe circoscritto a esso.
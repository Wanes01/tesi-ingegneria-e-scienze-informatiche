...
compaiono però nella documentazione dei servizi, i quali
espongono solo lo schema delle risposte e non come vengono popolate, e sono stati ricostruiti
sperimentalmente, osservando le risposte e confrontandole con il codice del
...
solo in parte, e collocano la traccia di esecuzione in \texttt{traceback}, un membro di estensione
che la RFC consente. Il client dà quindi la precedenza a \texttt{detail}, ripiega su

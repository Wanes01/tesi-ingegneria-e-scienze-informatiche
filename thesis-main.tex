...
\school{DIPARTIMENTO DI INFORMATICA -- SCIENZA E INGEGNERIA}
\logo{figures/marchio_ateneo}
...
\hangindent=1.5em A te Rebecca, che mi hai insegnato ad aprire il mio cuore, dopo essertelo preso. Non ci sono parole per dire quanto sia fortunato ad averti nella mia vita.

\hangindent=1.5em A te mamma, che mi hai sempre sostenuto al massimo delle tue capacità. So bene quanto ti sia sacrificata per me e Adel, anche solo per riuscire a farci trovare un pasto caldo a fine giornata. Spero di riuscire a ridarti mille volte l'amore che ci hai dimostrato.

\hangindent=1.5em A te Adel, che stai finalmente diventando grande, nella speranza che possa anche tu trovare la tua strada nella vita.

\hangindent=1.5em A te papà, che ci hai lasciati troppo presto. Spero tu possa guardarmi da lassù ed essere fiero di chi sono oggi. Vorrei tanto che ci fossi anche tu a festeggiare questo traguardo.

\hangindent=1.5em A te Muccioli, e a te Brusi, i miei migliori amici, che mi avete sempre perdonato tutte quelle volte in cui ho dovuto darvi buca. Prometto che troverò più tempo anche per voi.

\hangindent=1.5em A te Federico, che hai condiviso con me le stesse gioie e gli stessi dolori in questo percorso.

\hangindent=1.5em A te Cora, che da due anni illumini ogni mia giornata.

\hangindent=1.5em A te Emir, che dubiti sempre delle tue stesse capacità.

\vspace{1.5em}
Sono grato a tutti voi per avermi reso chi sono oggi, con ogni singola vostra parola o azione. Questa tesi rappresenta la fine di un lungo percorso, segnato da tante lacrime e altrettante soddisfazioni, ma anche l'inizio di uno nuovo, capace di colmarmi di speranza e ambizione.

\end{acknowledgements}

\end{document}

 che mi avete sempre perdonato tutte quelle volte in cui ho dovuto darvi buca. Prometto che troverò più tempo anche per voi.
